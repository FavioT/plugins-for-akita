...
export {IndexedEntityQuery} from './IndexedEntityQuery';
export {IndexedEntityStore, IndexedStoreConfigOptions} from './indexedEntityStore';
...
export {HasHashedByStoreEntities, upsertEntityStores} from './upsertEntityStores';

export {countLoading} from './operators/countLoading';
